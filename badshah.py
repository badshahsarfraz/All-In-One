#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Badshah Sarfraz
...
jalan2("\033[1;93mGit clone https://www.github.com/badshahsarfraz/All-In-One")
time.sleep(0.2)
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        os.system('xdg-open https://www.facebook.com/pubgproplayer9')
...
def pilih_super():
	...
	print "\033[1;92m•◈•▄▄▄▄▄▄▄▄▄▄▄▄•◈•\033[1;91mFb Tips & Tricks \033[1;92m•◈•▄▄▄▄▄▄▄▄▄▄▄▄•◈•"
	...
	p.map(main, id)
	print "\033[1;92m•◈•╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬•◈•\033[1;91mBHH FAST\033[1;92m•◈•╬╬╬╬╬╬╬╬╬╬╬╬•◈•"
	print "  \033[1;93m«---•◈•---Developed By Badshah-•◈•---»" #Dev:Badshah
